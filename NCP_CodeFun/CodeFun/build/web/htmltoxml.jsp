...
<%
    ...
    Name.appendChild(doc.createTextNode(request.getParameter("username")));
	...
	StreamResult file = new StreamResult(new File("C:\\Users\\Suvanika S Rajan\\Documents\\GitHub\\NCP_CodeFun\\add_user.xml"));
    //write data
